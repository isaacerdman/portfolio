                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                    {projects.map(project => (
                        ...
                        transform transition-transform duration-300 hover:scale-105'>
                            ...
                            <a href={project.github} className='inline-block bg-gradient-to-r from-orange-500 to-yellow-500
                            text-white px-4 py-2 rounded-full hover:scale-105' target='_blank' rel='noopener noreferrer'>Github</a>
                        </div>
                    ))}
                </div>
            </div>
