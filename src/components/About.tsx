        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          ...
          <div className="flex-1">
            <p className="text-lg mb-8">
              I am a Computer Science student with a desire to never stop
              learning. In a shifting sphere of technology, I balance time
              between developing hard skills as a developer and understanding
              AI. I'm passionate about owning a project and creating software to
              solve problems.
            </p>
